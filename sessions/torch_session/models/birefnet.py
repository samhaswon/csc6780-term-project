...
from sessions.torch_session.config import Config
from sessions.torch_session.models.backbones.build_backbone import build_backbone
from sessions.torch_session.models.modules.decoder_blocks import BasicDecBlk, ResBlk
from sessions.torch_session.models.modules.lateral_blocks import BasicLatBlk
from sessions.torch_session.models.modules.aspp import ASPP, ASPPDeformable

class_labels_TR_sorted = [0]
...
class BiRefNet(
    ...
    def forward_ori(self, x):
        ...
        # if self.on_devices:
        #     features = [x.to("cuda:0") for x in features]
...
class Decoder(nn.Module):
    ...
    def to_devices(self):
        self.ipt_blk5 = self.ipt_blk5.to("cuda:1")
        self.ipt_blk4 = self.ipt_blk4.to("cuda:1")
        self.ipt_blk3 = self.ipt_blk3.to("cuda:1")
        self.ipt_blk2 = self.ipt_blk2.to("cuda:1")
        self.ipt_blk1 = self.ipt_blk1.to("cuda:0")

        self.decoder_block4 = self.decoder_block4.to("cuda:1")
        self.decoder_block3 = self.decoder_block3.to("cuda:1")
        self.decoder_block2 = self.decoder_block2.to("cuda:1")
        self.decoder_block1 = self.decoder_block1.to("cuda:1")
        self.conv_out1 = self.conv_out1.to("cuda:0")

        self.lateral_block4 = self.lateral_block4.to("cuda:1")
        self.lateral_block3 = self.lateral_block3.to("cuda:1")
        self.lateral_block2 = self.lateral_block2.to("cuda:1")

        self.conv_ms_spvn_4 = self.conv_ms_spvn_4.to("cuda:1")
        self.conv_ms_spvn_3 = self.conv_ms_spvn_3.to("cuda:1")
        self.conv_ms_spvn_2 = self.conv_ms_spvn_2.to("cuda:1")

        self.gdt_convs_4 = self.gdt_convs_4.to("cuda:1")
        self.gdt_convs_3 = self.gdt_convs_3.to("cuda:1")
        self.gdt_convs_2 = self.gdt_convs_2.to("cuda:1")

        self.gdt_convs_pred_4 = self.gdt_convs_pred_4.to("cuda:1")
        self.gdt_convs_pred_3 = self.gdt_convs_pred_3.to("cuda:1")
        self.gdt_convs_pred_2 = self.gdt_convs_pred_2.to("cuda:1")

        self.gdt_convs_attn_4 = self.gdt_convs_attn_4.to("cuda:1")
        self.gdt_convs_attn_3 = self.gdt_convs_attn_3.to("cuda:1")
        self.gdt_convs_attn_2 = self.gdt_convs_attn_2.to("cuda:1")
        self.on_devices = True
