"""
Session classes for inference with:
- U2Net
- U2NetP
- DLMV
- BiRefNet_lite
...
class Session:
    """
    Session class for inference with:
    - U2Net
    - U2NetP
    - DLMV
    """
    def __init__(
        ...
        if sess_opts is None and "OpenVINOExecutionProvider" in self.providers:
...
class BiRefNetSession:
    """
    Session class for inference with BiRefNet_lite.
    """
    def __init__(
        self,
        model_path: str,
